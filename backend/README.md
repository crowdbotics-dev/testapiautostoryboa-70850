...
## Project Structure
    ...
    ├── testapiautostoryboa_70850  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_70850`
...
2. Clone this repo and `cd testapiautostoryboa_70850`
